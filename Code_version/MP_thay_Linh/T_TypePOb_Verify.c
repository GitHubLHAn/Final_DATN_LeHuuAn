 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Sat Dec 16 11:32:42 2023
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME T_TypePOb_Verify
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS            5
/* Input Port  0 */
#define IN_PORT_0_NAME        iL
...
/* Input Port  2 */
#define IN_PORT_2_NAME        Vo_refk1
...
extern void T_TypePOb_Verify_Start_wrapper(real_T *xD,
			SimStruct *S);
extern void T_TypePOb_Verify_Outputs_wrapper(const real_T *iL,
			const real_T *Vo,
			...
			const real_T *xD,
			SimStruct *S);
extern void T_TypePOb_Verify_Update_wrapper(const real_T *iL,
			const real_T *Vo,
			const real_T *Vo_refk1,
			const real_T *Vo_refk,
			const real_T *PWM,
...
static void mdlStart(SimStruct *S)
{
    ...
    T_TypePOb_Verify_Start_wrapper(xD, S);
}
#endif /*  MDL_START */
...
{
    const real_T *iL = (real_T *) ssGetInputPortRealSignal(S, 0);
    const real_T *Vo = (real_T *) ssGetInputPortRealSignal(S, 1);
    const real_T *Vo_refk1 = (real_T *) ssGetInputPortRealSignal(S, 2);
    const real_T *Vo_refk = (real_T *) ssGetInputPortRealSignal(S, 3);
    const real_T *PWM = (real_T *) ssGetInputPortRealSignal(S, 4);
    real_T *D = (real_T *) ssGetOutputPortRealSignal(S, 0);
    real_T *obFk = (real_T *) ssGetOutputPortRealSignal(S, 1);
    real_T *obXk = (real_T *) ssGetOutputPortRealSignal(S, 2);
    real_T *Iref = (real_T *) ssGetOutputPortRealSignal(S, 3);
    const real_T *xD = ssGetDiscStates(S);

    T_TypePOb_Verify_Outputs_wrapper(iL, Vo, Vo_refk1, Vo_refk, PWM, D, obFk, obXk, Iref, xD, S);
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
    ...
    T_TypePOb_Verify_Update_wrapper(iL, Vo, Vo_refk1, Vo_refk, PWM, D, obFk, obXk, Iref, xD, S);
