 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Tue Feb 27 22:02:17 2024
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME HSM_SMC
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS            4
/* Input Port  0 */
#define IN_PORT_0_NAME        RPM_sp
...
/* Output Port  2 */
#define OUT_PORT_2_NAME       Theta_est
...
/* Output Port  4 */
#define OUT_PORT_4_NAME       RPM_est
...
extern void HSM_SMC_Start_wrapper(void);
extern void HSM_SMC_Outputs_wrapper(const real_T *RPM_sp,
			const real_T *RPM_fb,
			const real_T *Ia_fb,
			const real_T *Ib_fb,
			real_T *m,
...
{
    const real_T *RPM_sp = (real_T *) ssGetInputPortRealSignal(S, 0);
    const real_T *RPM_fb = (real_T *) ssGetInputPortRealSignal(S, 1);
    const real_T *Ia_fb = (real_T *) ssGetInputPortRealSignal(S, 2);
    const real_T *Ib_fb = (real_T *) ssGetInputPortRealSignal(S, 3);
    real_T *m = (real_T *) ssGetOutputPortRealSignal(S, 0);
    real_T *ramp = (real_T *) ssGetOutputPortRealSignal(S, 1);
    real_T *Theta_est = (real_T *) ssGetOutputPortRealSignal(S, 2);
    real_T *Iq_sp = (real_T *) ssGetOutputPortRealSignal(S, 3);
    real_T *RPM_est = (real_T *) ssGetOutputPortRealSignal(S, 4);

    HSM_SMC_Outputs_wrapper(RPM_sp, RPM_fb, Ia_fb, Ib_fb, m, ramp, Theta_est, Iq_sp, RPM_est);
