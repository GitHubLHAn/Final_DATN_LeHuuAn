...
//========================================================================================================================
	...
	void ADC_Init(ADC_OBJECT *pADC)	{		
		...
		pADC->gain_I = (double)pADC->Vref_MCU/4096.0;		// 12 bit: 2^12-1=4095 
		...
		pADC->Vref_I_C1 = pADC->Vref_I_C1/100.0;// - 0.05;		//2.46
		pADC->Vref_I_C2 = pADC->Vref_I_C2/100.0;		//2.33
		HAL_ADC_Stop_DMA(&hadc1);
		
//		pADC->Vref_I_C1 = os[0];		//2.46
//		pADC->Vref_I_C2 = os[1];		//2.33
		pADC->rawV_Ia = 0; 
		pADC->rawV_Ib = 0;
		pADC->filterV_Ia = 0;
		pADC->filterV_Ib = 0;	
...
//			pADC->Vref_I_C2 += pADC->gain_I*pADC->data[1];
//		}
//		pADC->Vref_I_C1 /= 50;		//2.46
//		pADC->Vref_I_C2 /= 50;		//2.33
//		HAL_ADC_Stop_DMA(&hadc1);
